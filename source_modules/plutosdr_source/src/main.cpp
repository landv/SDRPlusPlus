...
private:
    ...
    static void menuSelected(void* ctx) {
        ...
        flog::info("PlutoSDRSourceModule '{0}': 菜单选择!", _this->name);
    }

    static void menuDeselected(void* ctx) {
        PlutoSDRSourceModule* _this = (PlutoSDRSourceModule*)ctx;
        flog::info("PlutoSDRSourceModule '{0}': 菜单取消选择!", _this->name);
    }
    ...
    static void start(void* ctx) {
        ...
        if (_this->ctx == NULL) {
            flog::error("无法打开 pluto ({})", _this->uri);
            return;
        }
        ...
        flog::info("PlutoSDRSourceModule '{0}': 启动!", _this->name);
    }
    ...
    static void stop(void* ctx) {
        ...
        flog::info("PlutoSDRSourceModule '{0}': 停止!", _this->name);
    }
    ...
    static void tune(double freq, void* ctx) {
        ...
        flog::info("PlutoSDRSourceModule '{0}': 调谐: {1}!", _this->name, freq);
    }
