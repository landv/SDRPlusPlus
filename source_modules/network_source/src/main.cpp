...
private:
    ...
    static void menuSelected(void* ctx) {
        ...
        flog::info("NetworkSourceModule '{0}': 菜单选择！", _this->name);
    }

    static void menuDeselected(void* ctx) {
        NetworkSourceModule* _this = (NetworkSourceModule*)ctx;
        flog::info("NetworkSourceModule '{0}': 菜单取消选择！", _this->name);
    }
    ...
    static void start(void* ctx) {
        ...
        try {
            ...
            flog::error("无法启动 Network Source: {}", e.what());
            return;
        }
        ...
        _this->running = true;
        flog::info("NetworkSourceModule '{0}': 开始！", _this->name);
    }
    ...
    static void stop(void* ctx) {
        ...
        _this->running = false;
        flog::info("NetworkSourceModule '{0}': 停止!", _this->name);
    }
    ...
    static void tune(double freq, void* ctx) {
        ...
        _this->freq = freq;
        flog::info("NetworkSourceModule '{0}': 调谐: {1}!", _this->name, freq);
    }
