...
private:
    ...
    static void menuSelected(void* ctx) {
        ...
        flog::info("SpectranSourceModule '{0}': 菜单选择!", _this->name);
    }

    static void menuDeselected(void* ctx) {
        SpectranSourceModule* _this = (SpectranSourceModule*)ctx;
        flog::info("SpectranSourceModule '{0}': 菜单取消选择!", _this->name);
    }
    ...
    static void start(void* ctx) {
        ...
        _this->running = true;
        flog::info("SpectranSourceModule '{0}': 启动!", _this->name);
    }
    ...
    static void stop(void* ctx) {
        ...
        flog::info("SpectranSourceModule '{0}': 停止!", _this->name);
    }
    ...
    static void tune(double freq, void* ctx) {
        ...
        _this->freq = freq;
        flog::info("SpectranSourceModule '{0}': 调谐: {1}!", _this->name, freq);
    }
    ...
    static void menuHandler(void* ctx) {
        ...
        if (SmGui::Checkbox(CONCAT("前置放大器##_spectran_preamp_", _this->name), &_this->preAmp)) {
            if (_this->running) {
                _this->updateAmps();
            }
        }
